...
Options.AimbotKeybind:OnClick(function() if Options.AimbotKeybind.Mode=='Toggle' then aimbotActive=Options.AimbotKeybind:GetState() end end)
Library:GiveSignal(RunService.Heartbeat:Connect(function() if Options.AimbotKeybind and Options.AimbotKeybind.Mode=='Hold' then aimbotActive=Options.AimbotKeybind:GetState() end end))
